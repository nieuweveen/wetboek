...
| | |
|---|---|
| Overheidsorganisatie      | Hoge Raad Nieuweveen |
| Officiële naam            | Algemeen Wetboek Nieuweveen |
| Citeertitel               | Wetboek Nieuweveen |
...
1. Het Wetboek Nieuweveen (verder aangeduid als WNRP) is leidend voor alle beschreven gevallen, waarbij als aanvulling het Nederlands Recht van toepassing is.
2. Het WNRP heeft betrekking op het vaste land, de gemeente, en de stad Nieuweveen.
3. Het WNRP is nauw verweven met de Algemene Plaatselijke Verordening Nieuweveen (APV). De APV dient echter als een indicerend kader voor eventuele bestraffing in-game (“in RP”) en is verder bedoeld voor het afhandelen van straffen buiten de RP om.
...
3. Minderjarigen worden binnen Nieuweveen op dezelfde manier behandeld als volwassenen. Alle bepalingen, straffen en dergelijke zijn ook van toepassing op hen. Minderjarigen hebben dezelfde rechten en plichten als volwassenen. Het jeugdstrafrecht is in Nieuweveen niet van toepassing.
...
3. Geldige redenen voor inbeslagname zijn:
    1. Plegen van een strafbaar feit uit het wetboek van Nieuweveen waarbij het goed direct of indirect betrokken is, behalve fout parkeren en een snelheidsovertreding met uitzondering zoals beschreven in lid E van dit artikel;
