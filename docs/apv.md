# Algemene Plaatselijke Verorden
...
2. Het gebruiken van externe communicatieplatforms (zoals Discord, Teamspeak, etc.) voor roleplay-gerelateerde communicatie tijdens het spelen op de server is niet toegestaan, tenzij hier expliciete toestemming van de staff voor is gegeven.
   ...
   - Het delen van bewijsmateriaal in daarvoor bestemde kanalen (zoals IC-bewijs) is toegestaan, mits dit is opgenomen met:
     - Bodycam (360°)
     - Dashcam (voor/achter)
     - Handheld telefoon (360°)
...
* **Building Ramming**: Geen voertuigen in gebouwstructuren
